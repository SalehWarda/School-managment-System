            ...
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('admin.quizzes.update')}}" method="post" autocomplete="off">
                                @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="name_ar" value="{{ $quizzes->getTranslation('name','ar') }}" class="form-control">
                                    </div>

                                    <div class="col">
                                        <label for="title">{{trans('quizzes.Quizze_English') }}</label>
                                        <input type="text" name="name_en" value="{{ $quizzes->getTranslation('name','en') }}" class="form-control">
                                    </div>
                                </div>
                                <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="subject_id">
                                                ...
                                                @foreach($subjects as $subject)
                                                    <option  value="{{ $subject->id }}" {{$quizzes->subject_id == $subject->id ? 'selected' : '' }}>{{ $subject->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" id="teacher_id" name="teacher_id">
                                                ...
                                                @foreach($teachers as $teacher)
                                                    <option  value="{{ $teacher->id }}" {{$quizzes->teacher_id == $teacher->id ? 'selected' : '' }}>{{ $teacher->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="grade_id">
                                                ...
                                                @foreach($grades as $grade)
                                                    <option  value="{{ $grade->id }}" {{$quizzes->grade_id == $grade->id ? 'selected' : '' }}>{{ $grade->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select mr-sm-2" name="section_id">
                                                ...
                                                <option  value="{{ $quizzes->section_id }}">{{ $quizzes->section->name }}</option>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('quizzes.Save_Changes') }}</button>
                            </form>
                        </div>
                    </div>
