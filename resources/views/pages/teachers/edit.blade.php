...
@section('content')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{trans('teachers.Edit_Teacher')}}</h4>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('admin.teachers.update')}}" method="post">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2"  name="specialization_id">
                                            ...
                                            @foreach($specializations as $specialization)
                                                <option
                                                    value="{{$specialization->id}}" @if($teacher->specialization_id == $specialization->id) selected @endif>{{$specialization->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <div class='input-group date'>
                                            <input class="form-control" value="{{$teacher->joining_date}}" type="text" id="datepicker-action"
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right"
                                        type="submit">{{trans('teachers.Save_Changes')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
