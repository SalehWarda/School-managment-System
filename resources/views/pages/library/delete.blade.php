<div class="modal fade" id="delete_book{{$book->id}}" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <form action="{{route('admin.library.delete')}}" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p> هل أنت متأكد من عملية الحذف؟ <span class="text-danger">{{$book->title}}</span></p>
                ...
                <div class="modal-footer">
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                                class="btn btn-danger">حذ الكتاب</button>
                    </div>
                </div>
            </div>
        </form>
